...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.aad.storyapp.TOAST_ACTION"
        const val EXTRA_ITEM = "com.aad.storyapp.EXTRA_ITEM"
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action != null) {
            if (intent.action == TOAST_ACTION) {
                ...
                Toast.makeText(context, "Touched item at index: $viewIndex", Toast.LENGTH_SHORT).show()
            }
        }
    }
}